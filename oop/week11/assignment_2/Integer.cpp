...
Number *Integer::add(Number * num) {
	...
	this->set_val(this->val() + cast->val());
	delete(cast);
	...
	Float* result = new Float((double)this->value + cast->val());
	delete(this);
	delete(cast);
	...
	Complex* result = new Complex((double)this->value + cast->real(), cast->imag());
	delete(this);
	delete(cast);
...
Number *Integer::sub(Number * num) {
    ...
    if (num->types() == INTEGER) {
        Integer* cast = dynamic_cast<Integer*>(num);
	this->set_val(this->value - cast->val());
	delete(cast);
...
Number *Integer::mul(Number * num) {
	...
	return result;
        ...
        Complex* cast = dynamic_cast<Complex*>(num);
	Complex* result = new Complex((double)this->value * cast->real(), cast->imag() * (double)this->value);
	delete(this);
	delete(cast);

...
Number *Complex::add(Number * num) {
	...
	Integer* cast = dynamic_cast<Integer*>(num);
	this->set_val(this->real() + (double)cast->val(), this->imag());
	...
	Float* cast = dynamic_cast<Float*>(num);
	this->set_val(this->real() + cast->val(), this->imag());
	delete(cast);
	...
	Complex* cast = dynamic_cast<Complex*>(num);
	this->set_val(this->real() + cast->real(), this->imag() + cast->imag());
	delete(cast);
...
Number *Complex::mul(Number * num) {
    ...
    if (num->types() == INTEGER) {
	Integer* cast = dynamic_cast<Integer*>(num);
	this->set_val(this->real() * (double)cast->val(), this->imag() * (double)cast->val());
	delete(cast);
	...
	Float* cast = dynamic_cast<Float*>(num);
	this->set_val(this->real() * cast->val(), this->imag() * cast->val());
	delete(cast);
	...
	Complex* cast = dynamic_cast<Complex*>(num);
	this->set_val((this->real() * cast->real()) - (this->imag() * cast->imag()),
			(this->real() * cast->imag()) + (this->imag() * cast->real()));
	delete(cast);
